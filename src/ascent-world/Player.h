...
#define MAX_PET_NO 3
#define PLAYER_NORMAL_RUN_SPEED 10.0f
#define PLAYER_NORMAL_SWIM_SPEED 8.722222f
...
// used for PLAYER_FIELD_KNOWN_PVPTITLES field
enum PlayerTitles
{
	PLAYER_TITLE_NONE					= 0x00000001, // 1
	PLAYER_TITLE_PRIVATE				= 0x00000002, // 2
	PLAYER_TITLE_CORPORAL				= 0x00000004, // 4
	PLAYER_TITLE_SERGEANT_A				= 0x00000008, // 8
	PLAYER_TITLE_MASTER_SERGEANT		= 0x00000010, // 16
	PLAYER_TITLE_SERGEANT_MAJOR			= 0x00000020, // 32
	PLAYER_TITLE_KNIGHT					= 0x00000040, // 64
	PLAYER_TITLE_KNIGHT_LIEUTENANT		= 0x00000080, // 128
	PLAYER_TITLE_KNIGHT_CAPTAIN			= 0x00000100, // 256
	PLAYER_TITLE_KNIGHT_CHAMPION		= 0x00000200, // 512
	PLAYER_TITLE_LIEUTENANT_COMMANDER	= 0x00000400, // 1024
	PLAYER_TITLE_COMMANDER				= 0x00000800, // 2048
	PLAYER_TITLE_MARSHAL				= 0x00001000, // 4096
	PLAYER_TITLE_FIELD_MARSHAL			= 0x00002000, // 8192
	PLAYER_TITLE_GRAND_MARSHAL			= 0x00004000, // 16384
	PLAYER_TITLE_SCOUT					= 0x00008000, // 32768
	PLAYER_TITLE_GRUNT					= 0x00010000, // 65536
	PLAYER_TITLE_SERGEANT_H				= 0x00020000, // 131072
	PLAYER_TITLE_SENIOR_SERGEANT		= 0x00040000, // 262144
	PLAYER_TITLE_FIRST_SERGEANT			= 0x00080000, // 524288
	PLAYER_TITLE_STONE_GUARD			= 0x00100000, // 1048576
	PLAYER_TITLE_BLOOD_GUARD			= 0x00200000, // 2097152
	PLAYER_TITLE_LEGIONNAIRE			= 0x00400000, // 4194304
	PLAYER_TITLE_CENTURION				= 0x00800000, // 8388608
	PLAYER_TITLE_CHAMPION				= 0x01000000, // 16777216
	PLAYER_TITLE_LIEUTENANT_GENERAL		= 0x02000000, // 33554432
	PLAYER_TITLE_GENERAL				= 0x04000000, // 67108864
	PLAYER_TITLE_WARLORD				= 0x08000000, // 134217728
	PLAYER_TITLE_HIGH_WARLORD			= 0x10000000, // 268435456
	PLAYER_TITLE_GLADIATOR				= 0x20000000, // 536870912
	PLAYER_TITLE_DUELIST				= 0x40000000, // 1073741824
};

// used for PLAYER_FIELD_KNOWN_PVETITLES field
enum PlayerKnownTitles2
{
	PLAYER_TITLE_CHALLENGER 			= 0x00000001, // 1
	PLAYER_TITLE_SCARAB_LORD 			= 0x00000002, // 2
	PLAYER_TITLE_CONQUEROR 				= 0x00000004, // 4
	PLAYER_TITLE_JUSTICAR				= 0x00000008, // 8
	PLAYER_TITLE_CHAMPION_OF_THE_NAARU	= 0x00000010, // 16
	PLAYER_TITLE_MERCILESS_GLADIATOR	= 0x00000020, // 32
	PLAYER_TITLE_OF_THE_SHATTERED_SUN	= 0x00000040, // 64
	PLAYER_TITLE_HAND_OF_ADAL			= 0x00000080, // 128
	PLAYER_TITLE_VENGEFUL_GLADIATOR		= 0x00000100, // 256
	PLAYER_TITLE_UNUSED13				= 0x00000200, // 512
	PLAYER_TITLE_UNUSED14				= 0x00000400, // 1024
	PLAYER_TITLE_UNUSED15				= 0x00000800, // 2048
	PLAYER_TITLE_UNUSED16				= 0x00001000, // 4096
	PLAYER_TITLE_UNUSED17				= 0x00002000, // 8192
	PLAYER_TITLE_UNUSED18				= 0x00004000, // 16384
	PLAYER_TITLE_UNUSED19				= 0x00008000, // 32768
	PLAYER_TITLE_UNUSED20				= 0x00010000, // 65536
	PLAYER_TITLE_UNUSED21				= 0x00020000, // 131072
	PLAYER_TITLE_UNUSED22				= 0x00040000, // 262144
	PLAYER_TITLE_UNUSED23				= 0x00080000, // 524288
	PLAYER_TITLE_UNUSED24				= 0x00100000, // 1048576
	PLAYER_TITLE_UNUSED25				= 0x00200000, // 2097152
	PLAYER_TITLE_UNUSED26				= 0x00400000, // 4194304
	PLAYER_TITLE_UNUSED27				= 0x00800000, // 8388608
	PLAYER_TITLE_UNUSED28				= 0x01000000, // 16777216
	PLAYER_TITLE_UNUSED29				= 0x02000000, // 33554432
	PLAYER_TITLE_UNUSED30				= 0x04000000, // 67108864
	PLAYER_TITLE_UNUSED31				= 0x08000000, // 134217728
	PLAYER_TITLE_UNUSED32				= 0x10000000, // 268435456
	PLAYER_TITLE_UNUSED33				= 0x20000000, // 536870912
	PLAYER_TITLE_UNUSED34				= 0x40000000, // 1073741824
};
enum PvPAreaStatus
{
	AREA_ALLIANCE	= 1,
...
public:
	...
	/************************************************************************/
	/* Custom RockStar Functions											*/
	/************************************************************************/
	uint32 RS_getAccess();
	void KnockUp(float f);
...
public:
	...
	void GiveItem(uint32 entry, uint32 count);
	...
	ASCENT_INLINE void	PushToFinishedDailies(uint32 questid) { m_finishedDailies.insert(questid); }
	...
	ASCENT_INLINE uint32 GetFinishedDailyCount() { return uint32(m_finishedDailies.size()); }
	...
	bool				_HasQuestForItem(uint32 itemid);
	...
	ASCENT_INLINE uint32 GetTeamInitial() { return ( (myRace->team_id == 7) ? TEAM_HORDE : TEAM_ALLIANCE ); }
	...
	uint32 GetFactionId()
	{
		return (uint32)(GetUInt32Value(UNIT_FIELD_FACTIONTEMPLATE));
	}
	// factions variables
	...
	ASCENT_INLINE bool			InSameGroupAs(Player * plyr)
	{
		if( GetGroup() != NULL && plyr != NULL )
		{
			if(plyr->GetGroup() != NULL)
				return ( GetGroup() == plyr->GetGroup() );
		}
		return false;
	}
	...
	void						SpawnActivePet();
	void						DespawnPet();
	ASCENT_INLINE uint8			GetPetCount(void) { return (uint8)m_Pets.size(); }
	...
	/*	Titles																	*/
	/****************************************************************************/
	ASCENT_INLINE bool HasTitle( CharTitlesEntry * ct, uint32 titleType );
	ASCENT_INLINE uint32 FindTitle(uint32 index);
	void AddTitle( CharTitlesEntry * ct, uint32 titleType, bool SendNotification = true );
	ASCENT_INLINE void RemoveTitle( CharTitlesEntry * ct, uint32 titleType, bool SendNotification = true, bool SoftRemove = false);
	ASCENT_INLINE void SendTitleUpdate( CharTitlesEntry * ct, bool add, bool SendNotification);
	/****************************************************************************/
	/*	Item Interface															*/
	/****************************************************************************/
	...
	/************************************************************************/
	void SaveToDB(bool bNewCharacter, bool SaveCmd = false);
	...
	bool jumping;
	//Invisibility stuff
	uint32 m_isGmInvisible;

	void GoInvisible(bool enable, uint32 invisType = 0, bool addVisual = true);
	void AddAuraByID(uint32 SpellId);
	/************************************************************************/
	/*	Channel stuff														*/
	/************************************************************************/
...
*/
	...
	void CheckZoneAuras(uint32 ZoneId);
	...
	ASCENT_INLINE uint32 GetPersistentInstanceId(uint32 mapId, uint32 difficulty)
	{
...
public:
	...
	void ModTalentPoints(int amount)
	{
		ModUnsigned32Value(PLAYER_CHARACTER_POINTS1, amount);
	}
	...
	ASCENT_INLINE const char* getClassC()
	{
		static const char* classes[12] =
		{"None","Warrior", "Paladin", "Hunter", "Rogue", "Priest", "None", "Shaman", "Mage", "Warlock", "Mohawk", "Druid"};
		return classes[getClass()];
	};
	ASCENT_INLINE const char* getRaceC()
	{
	...
	******************/
	...
	ASCENT_INLINE void SetAttacking(bool set) { m_attacking = set; }
