...
enum ServerHookEvents
{
	...
	SERVER_HOOK_EVENT_ON_TITLE_EARNED		= 30,
	SERVER_HOOK_EVENT_ON_CONTINENT_CREATE	= 31,
	SERVER_HOOK_EVENT_ON_POST_SPELL_CAST	= 32,
...
enum GossipIcons
{
	GOSSIP_ICON_TXTBALLOON					= 0,
	GOSSIP_ICON_VENDOR						= 1,
	GOSSIP_ICON_TAXI						= 2,
	GOSSIP_ICON_TRAINER						= 3,
	GOSSIP_ICON_GEAR						= 4,
	GOSSIP_ICON_INNKEEPER					= 5,
	GOSSIP_ICON_BG							= 9
};
...
typedef void(*tOnTitleEarned)(CharTitlesEntry * ct, Player * pPlayer);
typedef void(*tOnContinentCreate)(MapMgr *pMgr);
...
public:
	...
	void OnTitleEarned(CharTitlesEntry * ct, Player * pPlayer);
