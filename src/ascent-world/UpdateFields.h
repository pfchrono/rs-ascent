...
#define PLAYER_FIELD_KNOWN_PVPTITLES							UNIT_END + 0x2B2	//	Size: 2, Type: GUID, Flags: 2
#define PLAYER_FIELD_KNOWN_PVETITLES							UNIT_END + 0x2B3	//	Size: 2, Type: GUID, Flags: 2
...
#define CORPSE_FIELD_DISPLAY_ID									OBJECT_END + 0x0007
