...
enum GuildRankRights
{
	...
	GR_RIGHT_GUILD_BANK_UPDATE_TEXT		= 0x04,
};
...
public:
	...
	/* Sends the info to the guild banktab to this client.	+	 */	
	void SetGuildBankTabInfo(WorldSession * pClient,uint8,string);
	void SendGuildBankTabInfo(WorldSession * pClient,uint8 TabId);	
