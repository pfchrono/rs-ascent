...
enum MOD_TYPES
{
	...
	SPELL_AURA_MOD_TOTAL_HEALTH_REGEN_PCT						= 20,	// Mod Total Health Regen percentage
	SPELL_AURA_MOD_TOTAL_MANA_REGEN_PCT							= 21,	// Mod Total Mana Regen percentage
	...
	SPELL_AURA_MELEE_SLOW_PCT									= 192,	// Reduces attacker's melee attacking speed
	SPELL_AURA_INCREASE_TIME_BETWEEN_ATTACKS					= 193,	// Increases time between attacks
	...
	SPELL_AURA_MOD_ALL_WEAPON_SKILLS							= 196,	// Mod All Weapon Skills
	SPELL_AURA_REDUCE_ATTACKER_CRICTICAL_HIT_CHANCE_PCT			= 197,	// Reduces Attacker Crit Chance %
	SPELL_AURA_INCREASE_SPELL_HIT_PCT							= 199,	// Increases Spell Hit %
	SPELL_AURA_CANNOT_BE_DODGED									= 201,	// Cannot be dodged
	SPELL_AURA_FINISHING_MOVES_CANNOT_BE_DODGED					= 202,	// Finishing moves cannot be dodged
	SPELL_AURA_REDUCE_ATTACKER_CRICTICAL_HIT_DAMAGE_MELEE_PCT	= 203,	// Reduces Attacker Critical Hit Damage Melee %
	SPELL_AURA_REDUCE_ATTACKER_CRICTICAL_HIT_DAMAGE_RANGED_PCT	= 204,	// Reduces Attacker Critical Hit Damage Ranged %
	SPELL_AURA_INCREASE_RANGED_ATTACK_POWER_PCT_OF_INTELLECT	= 212,	// Increases Ranged Attack Power % of Intellect
	SPELL_AURA_INCREASE_RAGE_FROM_DAMAGE_DEALT_PCT				= 213,	// Increases Rage from Damage Dealt %
	SPELL_AURA_INCREASE_CASTING_TIME_PCT						= 216,	// Increases Casting Time %
	SPELL_AURA_REGEN_MANA_STAT_PCT								= 219,	// Regen Mana Stat %
	SPELL_AURA_HEALING_STAT_PCT									= 220,	// Healing Stat %
	SPELL_AURA_INCREASE_MAX_HEALTH								= 230,	// Used by Commanding Shout
	SPELL_AURA_MODIFY_AXE_SKILL									= 240,	// Modify Axe Skill
	SPELL_AURA_241												= 241,
...
//	void SpellAuraIncreaseHealingByInt(bool apply);
	...
	Modifier * mod;
	uint32 m_dmgdone;
	AreaAuraList targets;								// This is only used for AreaAura(AA)
	Object* m_caster;
	uint64 m_casterGuid;
