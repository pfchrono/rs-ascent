...
#define _GAME
//xxxxxxxxxxxxxxxxxxxxxxxxxx ROCKSTAR DEFINES xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
//#define EGARI_DEBUG.
//#define USE_BUG_REPORT_SYSTEM
...
//#define USE_VENDORSTABLE_EXCOST

#include "SpeedDetector.h"

//#define LOGPACKET(packet) sWorldLog.LogPacket((uint32)packet.size(), packet.GetOpcode(), packet.contents(), 1);
