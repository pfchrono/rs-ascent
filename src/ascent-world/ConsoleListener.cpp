...
void HandleConsoleInput(BaseConsole * pConsole, const char * szInput)
{
	static ConsoleCommand Commands[] = {
		...
		{ &HandleOnlinePlayersCommand, "online", "none", "Shows online players." }, // Why was this disabled?
		...
		{ &HandleReloadAccounts, "reloadaccounts", "none", "Reloads accounts on logonserver" },
		{ &HandleSaveallPlayers, "saveall", "none", "saves all online players"},
		{ &HandleSAnnounceCommand, "sannounce", "<announce string>", "Shows the message on all client screens." },
//		{ &HandleShutDownCommand, "exit", "[delay]", "Shuts down server with optional delay in seconds." },
		...
		{ &HandleSendToChanCommand, "tochan", "<channel> <message>", "Sends a message to a specified channel," },
		{ &HandleConsoleWBuffCommand, "wbuff", "none", "Gives all players online a buff" },
		{ &HandleReloadTableCommand, "reloadtable", "<tablename>", "Reloads table <tablename>" },
		{ NULL, NULL, NULL, NULL },
	};
