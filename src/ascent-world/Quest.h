...
enum QUEST_FLAGS
{
	QUEST_FLAG_NONE			= 0x00000000,	// 0
	QUEST_FLAG_DELIVER		= 0x00000001,	// 1
	QUEST_FLAG_KILL			= 0x00000002,	// 2
	QUEST_FLAG_SPEAKTO		= 0x00000004,	// 4
	QUEST_FLAG_REPEATABLE	= 0x00000008,	// 8
	QUEST_FLAG_EXPLORATION	= 0x00000010,	// 16
	QUEST_FLAG_TIMED		= 0x00000020,	// 32
	QUEST_FLAG_REPUTATION	= 0x00000080,	// 128

	// Custom flags
	QUEST_FLAG_ONLY_ONE_REQUIRED	= 0x00010000,	// 65536
};
...
enum QUEST_REPEATABLE_TYPE
{
	QUEST_REPEATABLE			= 0x01,
	QUEST_REPEATABLE_DAILY		= 0x02,
};
