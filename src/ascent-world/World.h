...
public:
	...
	void SendGMWorldText(const char* text);
	void LogWriteFromSession(WorldSession * m_session, uint32 LogType, const char * text);
	void CallAccountReload();
	...
	void ToolDisconnectPlayer(DatabaseConnection * con);
