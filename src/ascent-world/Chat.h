...
enum ChatMsg
{
	...
	CHAT_MSG_YELL									= 6,
	CHAT_MSG_WHISPER								= 7,
	CHAT_MSG_WHISPER_MOB							= 8,	//CHAT_MSG_WHISPER_INFORM	= 0x08,		8
	CHAT_MSG_WHISPER_INFORM							= 9,	//CHAT_MSG_REPLY			= 0x09,		9
	CHAT_MSG_EMOTE									= 10,
...
class SERVER_DECL CommandTableStorage : public Singleton<CommandTableStorage>
{
	...
	ChatCommand * _reportCommandTable;
	ChatCommand * _bugReportCommandTable;
...
protected:
	...
	bool HandleVIPListCommand(const char* args, WorldSession *m_session);
	...
	bool HandleIsOnlineCommand(const char *args, WorldSession *m_session);
	...
	bool HandleServerAnnounceCommand(const char* args, WorldSession *m_session);
	...
	bool HandleChatTagCommand(const char* args, WorldSession *m_session);
	...
	bool HandleNPCStandStateCommand(const char* args, WorldSession *m_session);
	...
	bool HandleInitializeAllQueuedBGsCommand(const char *args, WorldSession *m_session);
	...
	bool HandlePlaySoundCommand2(const char* args, WorldSession * m_session);
	...
	/*	- Begin RS Commands -														*/
	/********************************************************************************/
	bool HandleResetAllTalents(const char* args, WorldSession *m_session);
	bool HandleReloadAccounts(const char* args, WorldSession *m_session);
	bool HandleGetAccountCommand(const char* args, WorldSession *m_session);
	bool HandleAddAuraCommand(const char* args, WorldSession *m_session);
	bool HandleRemoveAuraCommand(const char* args, WorldSession *m_session);
	bool HandleWorldBuffCommand(const char* args, WorldSession *m_session);
	bool HandleTaxiJumpToEndCommand(const char* args, WorldSession *m_session);
	bool HandleGetSkillCommand(const char* args, WorldSession *m_session);
	bool SendCastResult_Debug(const char* args, WorldSession *m_session);
	bool HandleSetValue(const char* args, WorldSession *m_session);
	bool HandleNPCBytes2Command(const char* args, WorldSession *m_session);
	// -- TITLE COMMANDS
	bool HandleKnownPVPTitlesCommand(const char* args, WorldSession *m_session);
	bool HandleKnownPVETitlesCommand(const char* args, WorldSession *m_session);
	bool HandleAddPVPTitle(const char* args, WorldSession *m_session);
	bool HandleAddPVETitle(const char* args, WorldSession *m_session);
	bool HandleRemovePVPTitle(const char* args, WorldSession *m_session);
	bool HandleRemovePVETitle(const char* args, WorldSession *m_session);
	/********************************************************************************/
	/*	- End RS Commands -															*/
	/********************************************************************************/
...
//	bool HandleRecall_GMListCommand(const char* args, WorldSession *m_session);
	...
	bool HandleRecallGMOnlyAddCommand(const char* args, WorldSession *m_session);
	...
	/* RockStar Commands */
	// Warn System Commands -- Level1.cpp
	...
	// Player Report System Commands -- Level1.cpp
	bool HandleReportPlr(const char* args, WorldSession *m_session);
	bool HandlePlrReportsGetCommand(const char* args, WorldSession *m_session);
	bool HandlePlrReportsDeleteCommand(const char* args, WorldSession *m_session);
	// Bug Report System commands
	bool HandleGenerateBugReport(const char* args, WorldSession *m_session);
	bool HandleBugReportsListCommand(const char* args, WorldSession *m_session);
	bool HandleGetBugReportByIdCommand(const char* args, WorldSession *m_session);
	// Ranged.
	bool HandleMorphAllInRange(const char* args, WorldSession *m_session);
	bool HandleDeMorphAllInRange(const char* args, WorldSession *m_session);
	bool HandleRangeBuffCommand(const char* args, WorldSession *m_session);
	// Guild Related
	bool HandleGuildHomeCommand(const char* args, WorldSession *m_session);
	bool HandleGoToGuildHomeCommand(const char* args, WorldSession *m_session);
	// Misc.
	bool HandleKnockUp(const char* args, WorldSession *m_session);
	bool HandleWaterWalkCommand(const char* args, WorldSession *m_session);
	bool HandleExtendedCharInfoCommand(const char* args, WorldSession *m_session);
	bool HandleReloadScriptsCommand(const char* args, WorldSession *m_session);
};
