...
enum AUCTION_RESULT_ERROR
{
	AUCTION_ERROR_NONE					= 0,
	AUCTION_ERROR_INTERNAL_BAG_ERROR	= 1,
	AUCTION_ERROR_INTERNAL_REGULAR		= 2,
	AUCTION_ERROR_NOT_ENOUGH_MONEY		= 3,
	AUCTION_ERROR_ITEM_NOT_FOUND		= 4,
	AUCTION_ERROR_ALREADY_A_HIGHER_BID	= 5,
	AUCTION_ERROR_INCREMENT_TOO_SMALL	= 7,
	AUCTION_ERROR_CANT_BID_OWN_AUCTION	= 10,
	AUCTION_ERROR_TRIAL_ACCOUNT			= 13,
};
