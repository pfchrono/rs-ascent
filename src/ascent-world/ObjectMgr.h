...
typedef std::multimap< uint32, uint32 >					SpellSpellRelationMap;
...
public:
	...
	void SafeDeleteObj(WorldPacket * data);
	void SafeDeleteObj(Object *pObj);
	...
	bool HasExtendedCost(uint32 itemid);
	...
	void LoadDisabledSpells(bool reload = false);
	...
	std::set<ExtendedCostItem*> ExtendedCostItemTable;
	
	SpellSpellRelationMap SpellSpellRelationTable;
