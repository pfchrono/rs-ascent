...
/*
	...
	m_worldStates.clear();
*/
	Log.Debug("MapMgr", "Instance %u shut down. (%s)" , m_instanceID, GetBaseMap()->GetName());
}
/*
...
void MapMgr::ChangeObjectLocation( Object *obj )
{
	...
	if( !obj || obj->GetTypeId() == TYPEID_ITEM || obj->GetTypeId() == TYPEID_CONTAINER || obj->GetMapMgr() != this )
	{
		return;
	}
