...
enum ITEM_PET_FOODTYPE
{
	PET_FOODTYPE_MEAT	= 1,
	PET_FOODTYPE_FISH	= 2,
	PET_FOODTYPE_CHEESE	= 3,
	PET_FOODTYPE_BREAD	= 4,
	PET_FOODTYPE_FUNGUS	= 5,
	PET_FOODTYPE_FRUIT	= 6,
};
...
{
	ITEM_TYPE_BOWAMMO		= 0x1,		// 1	- Arrows
	ITEM_TYPE_GUNAMMO		= 0x2,		// 2	- Bullets
	ITEM_TYPE_SOULSHARD		= 0x4,		// 4	- Soul Shards
	ITEM_TYPE_LEATHERWORK	= 0x8,		// 8	- Leatherworking Supplies
	ITEM_TYPE_HERBALISM		= 0x20,		// 32	- Herbs
	ITEM_TYPE_ENCHANTMENT	= 0x40,		// 64	- Enchanting Supplies
	ITEM_TYPE_ENGINEERING	= 0x80,		// 128	- Engineering Supplies
	ITEM_TYPE_KEYRING		= 0x100,	// 256	- Keys
	ITEM_TYPE_GEMS			= 0x200,	// 512	- Gems
	ITEM_TYPE_MINING		= 0x400,	// 1024	- Mining Supplies
	ITEM_TYPE_SBEQUIPMENT	= 0x800,	// 2048	- Soulbound Equipment
	ITEM_TYPE_VANITYPETS	= 0x1000	// 4096	- Vanity Pets
};
...
enum Item_SheathType
{
    ITEM_SHEATHTYPE_NONE                   = 0,
    ITEM_SHEATHTYPE_MAINHAND               = 1,
    ITEM_SHEATHTYPE_OFFHAND                = 2,
    ITEM_SHEATHTYPE_LARGEWEAPONLEFT        = 3,
    ITEM_SHEATHTYPE_LARGEWEAPONRIGHT       = 4,
    ITEM_SHEATHTYPE_HIPWEAPONLEFT          = 5,
    ITEM_SHEATHTYPE_HIPWEAPONRIGHT         = 6,
    ITEM_SHEATHTYPE_SHIELD                 = 7
};
