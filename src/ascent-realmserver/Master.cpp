...
int main(int argc, char *argv[])
{
	...
	if(Database_Character->Initialize("localhost", 3306, "root", "antrixftw", "ascentrockstar", 1, 1000) &&
		Database_World->Initialize("localhost", 3306, "root", "antrixftw", "ascentrockstar", 1, 1000))
	{
