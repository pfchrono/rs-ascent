...
public:
	...
	void writefromconsole(const char* format, ...);
...
extern SessionLogWriter * Chat_Log;
extern SessionLogWriter * Chan_Log;
extern SessionLogWriter * Session_Log;
extern SessionLogWriter * MailInsert_Log;
extern SessionLogWriter * SentMail_Log;

#define sLog oLog::getSingleton()
#define sCheatLog (*Anticheat_Log)
#define sGMLog (*GMCommand_Log)
#define sMailLog (*MailInsert_Log)
#define sPlrLog (*Player_Log)
#define sChatLog (*Chat_Log)
#define sChanLog (*Chan_Log)
#define sSessionLog (*Session_Log)
#define sSentMailLog (*SentMail_Log)
