...
//	char*		name2[16];									// 19-34, unused
	...
	uint32		bit_index;									// 36, used in PLAYER_CHOSEN_TITLE and (uint32(1) << bit_index) in PLAYER__FIELD_KNOWN_TITLES and PLAYER__FIELD_KNOWN_TITLES_X
};
