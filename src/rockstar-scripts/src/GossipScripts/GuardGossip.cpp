...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
        ...
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Auction House", 1);
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Bank of Stormwind", 2);
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Deeprun Tram", 3);
        Menu->AddItem(GOSSIP_ICON_INNKEEPER, "The Inn", 4);
        Menu->AddItem(GOSSIP_ICON_TAXI, "Gryphon Master", 5);    
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Guild Master", 6);
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Mailbox", 7);
        Menu->AddItem(GOSSIP_ICON_TRAINER, "Stable Master", 8);
        Menu->AddItem(GOSSIP_ICON_TRAINER, "Weapons Trainer", 9);
        Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Officers' Lounge", 10);
        Menu->AddItem(GOSSIP_ICON_BG, "Battlemaster", 11);
        Menu->AddItem(GOSSIP_ICON_TRAINER, "Class Trainer", 12);
        Menu->AddItem(GOSSIP_ICON_TRAINER, "Profession Trainer", 13);
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 12:    // Class Trainers
            {
				...
				Menu->AddItem( GOSSIP_ICON_TRAINER, "Druid"      , 14);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Hunter"     , 15);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Mage"       , 16);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Paladin"    , 17);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Priest"     , 18);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Rogue"      , 19);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Shaman"     , 20);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Warlock"    , 21);
				Menu->AddItem( GOSSIP_ICON_TRAINER, "Warrior"    , 22);
                Menu->SendTo(Plr);
            }break;
        ...
        case 13:    // Profession Trainers
            {
                objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 4264, Plr);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Alchemy"           , 23);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Blacksmithing"     , 24);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Cooking"           , 25);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Enchanting"        , 26);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Engineering"       , 27);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "First Aid"         , 28);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Fishing"           , 29);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Herbalism"         , 30);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Leatherworking"    , 31);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Mining"            , 32);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Skinning"          , 33);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Tailoring"         , 34);
                Menu->SendTo(Plr);
            }break;
...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
		...
		Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Auction House", 1 );
        Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Bank of Darnassus", 2 );
        Menu->AddItem( GOSSIP_ICON_TAXI, "Hippogryph Master"  , 3 );
        Menu->AddItem( GOSSIP_ICON_VENDOR, "Guild Master"       , 4 );
        Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "The Inn", 5);
        Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Mailbox", 6);
        Menu->AddItem( GOSSIP_ICON_VENDOR, "Stable Master", 7);
        Menu->AddItem( GOSSIP_ICON_TRAINER, "Weapons Trainer", 8);
        Menu->AddItem( GOSSIP_ICON_BG, "Battlemaster", 9);
        Menu->AddItem( GOSSIP_ICON_TRAINER, "Class Trainer", 10);
	 	Menu->AddItem( GOSSIP_ICON_TRAINER, "Profession Trainer", 11);
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
		...
		case 10:    // Class Trainer
            {
                objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 4264, Plr);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Druid"       , 12);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Hunter"      , 13);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Priest"      , 14);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Rogue"       , 15);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Warrior"     , 16);
                Menu->SendTo(Plr);
            }break;
        ...
        case 11:    // Profession Trainer
            {
                ...
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Alchemy"           , 17);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Cooking"           , 18);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Enchanting"        , 19);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "First Aid"         , 20);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Fishing"           , 21);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Herbalism"         , 22);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Leatherworking"    , 23);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Skinning"          , 24);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Tailoring"         , 25);
                Menu->SendTo(Plr);
            }break;
...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
        GossipMenu *Menu;
        objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 2593, Plr);
		Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Bank"                 , 1);
		Menu->AddItem( GOSSIP_ICON_TAXI, "Gryphon Master"       , 2);
		Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Guild Master"         , 3);
		Menu->AddItem( GOSSIP_ICON_INNKEEPER, "Inn"                  , 4);
		Menu->AddItem( GOSSIP_ICON_TXTBALLOON, "Stable Master"        , 5);
		Menu->AddItem( GOSSIP_ICON_TRAINER, "Class Trainer"        , 6);
		Menu->AddItem( GOSSIP_ICON_TRAINER, "Profession Trainer"   , 7);
        if(AutoSend)
            Menu->SendTo(Plr);
    }
	...
	void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
	   ...
	   case 6:     //Class Trainer
	       ...
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Druid",                8);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Hunter",               9);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Mage",                 10);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Paladin",              11);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Priest",               12);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Rogue",                13);
		   Menu->AddItem( GOSSIP_ICON_TRAINER, "Shaman",               14);
	       Menu->AddItem( GOSSIP_ICON_TRAINER, "Warlock",              15);
		   Menu->AddItem( GOSSIP_ICON_TRAINER, "Warrior",              16);
		...
		case 7:		//Profession Trainer
			...
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Alchemy"              ,17);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Blacksmithing"        ,18);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Cooking"              ,19);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Enchanting"           ,20);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Engineering"          ,21);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "First Aid"            ,22);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Fishing"              ,23);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Herbalism"            ,24);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Leatherworking"       ,25);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Mining"               ,26);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Skinning"             ,27);
			Menu->AddItem( GOSSIP_ICON_TRAINER, "Tailoring"            ,28);
			Menu->SendTo(Plr);
			}break;
...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
		...
		Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "Undercity Bank", 1);
		Menu->AddItem(GOSSIP_ICON_TAXI, "The Bat Handler", 2);
		Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "The Guild Master", 3);
		Menu->AddItem(GOSSIP_ICON_INNKEEPER, "The Inn", 4);
		Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "The Mailbox", 5);
		Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "The Auction House", 6);
		Menu->AddItem(GOSSIP_ICON_TAXI, "The zeppelin master", 7);
		Menu->AddItem(GOSSIP_ICON_TRAINER, "The weapon master", 8);
		Menu->AddItem(GOSSIP_ICON_VENDOR, "The stable master", 9);
		Menu->AddItem(GOSSIP_ICON_BG, "The battlemaster", 10);
		Menu->AddItem(GOSSIP_ICON_TRAINER, "A class trainer", 11);
		Menu->AddItem(GOSSIP_ICON_TRAINER, "A profession trainer", 12);
        if(AutoSend)
            Menu->SendTo(Plr);
    }
        ...
        case 11:    // A class trainer
            {
                ...
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Mage"		 , 13);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Paladin"      , 14);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Priest"       , 15);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Rogue"        , 16);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Warlock"      , 17);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Warrior"      , 18);
                Menu->SendTo(Plr);
            }break;
        ...
        case 12:    // A profession trainer
            {
                ...
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Alchemy"           , 19);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Blacksmithing"     , 20);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Cooking"           , 21);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Enchanting"        , 22);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Engineering"       , 23);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "First Aid"         , 24);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Fishing"           , 25);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Herbalism"         , 26);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Leatherworking"    , 27);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Mining"            , 28);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Skinning"          , 29);
                Menu->AddItem( GOSSIP_ICON_TRAINER, "Tailoring"         , 30);
                Menu->SendTo(Plr);
            }break;
...
/*****************************************************************************************/
/* RockStar Nation Gurads ----------------------------------------------------- by T0asT */
/*****************************************************************************************/

class SCRIPT_DECL RNGuard : public GossipScript
{
public:
	void Destroy()
	{
	...
	void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
	{
		...
		Menu->AddItem(0, "Class Trainers", 2);
		Menu->AddItem(0, "Profession Trainers", 3);
		Menu->AddItem(0, "Quest Givers", 4);
		Menu->AddItem(0, "Quest Areas", 5);
	...
	void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
	{
		...
		case 1:		// Text
			SendQuickMenu(1);
			//Plr->Gossip_SendPOI(x, y, 6, 6, 0, "Text");
		break;

		case 2:		//Trainers Lounge
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -135.06, -458.82, 6, 6, 0, "Trainers Lounge");
		break;

		case 3:		// Profession Menu
			{
				objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 1, Plr);
				Menu->AddItem( 0, "Alchemy", 6);
				Menu->AddItem( 0, "Blacksmithing", 7);
				Menu->AddItem( 0, "Cooking", 8);
				Menu->AddItem( 0, "Enchanting", 9);
				Menu->AddItem( 0, "Engineering", 10);
				Menu->AddItem( 0, "First Aid", 11);
				Menu->AddItem( 0, "Fishing", 12);
				Menu->AddItem( 0, "Herbalism", 13);
				Menu->AddItem( 0, "Jewlcrafting", 14);
				Menu->AddItem( 0, "Leatherworking", 15);
				Menu->AddItem( 0, "Mining", 16);
				Menu->AddItem( 0, "Skinning", 17);
				Menu->AddItem( 0, "Tailoring", 18);
				Menu->SendTo(Plr);
			}break;
		...
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -2.07, -441.64, 6, 6, 0, "Quest Givers");
			}break;

		case 5:		//Quest Areas Menu
		{
			objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 1, Plr);
			Menu->AddItem( 0, "Cows", 19);
			Menu->AddItem( 0, "Patty (Cow God)", 20);
			Menu->AddItem( 0, "Frogs", 21);
			Menu->AddItem( 0, "Eanna (Frog God)", 22);
			Menu->AddItem( 0, "Murloc Man", 23);
			Menu->AddItem( 0, "Snakes", 24);
			Menu->AddItem( 0, "Ms. Hissyfit (Snake God)", 25);
			Menu->AddItem( 0, "Spiders", 26);
			Menu->AddItem( 0, "Spider Queen", 27);
			Menu->AddItem( 0, "Yeti", 28);
			Menu->SendTo(Plr);
			}break;
		...
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -188.019, 45.99, 6, 6, 0, "Alchemy Trainer");
			}break;

		case 7:		//Blacksmithing
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -99.05, -585.766, 6, 6, 0, "Blacksmithing Trainer");
			}break;

		case 8:		//Cooking
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 25.59, -419.20, 6, 6, 0, "Cooking Trainer");
			}break;

		case 9:		//Enchanting
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -911.82, -526.47, 6, 6, 0, "Enchanting Trainer");
			}break;

		case 10:		//Engineering
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -387.59, -513.91, 6, 6, 0, "Engineering Trainer");
			}break;

		case 11:		//First Aid
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -45.72, -419.20, 6, 6, 0, "First Aid Trainer");
			}break;

		case 12:		//Fishing
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 421.95, -290.79, 6, 6, 0, "Fishing Trainer");
			}break;

		case 13:		//Herbalism
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -187.54, 24.00, 6, 6, 0, "Herbalism Trainer");
			}break;

		case 14:		//Jewlcrafting
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -955.53, -214.14, 6, 6, 0, "Jewelcrafting Trainer");
			}break;

		case 15:		//Leatherworking
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 204.79, -366.81, 6, 6, 0, "Leatherworking Trainer");
			}break;

		case 16:		//Mining
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( -955.53, -214.14, 6, 6, 0, "Mining Trainer");
			}break;

		case 17:		//Skinning
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 204.79, -366.81, 6, 6, 0, "Skinning Trainer");
			}break;

		case 18:		//Tailoring
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 204.79, -366.81, 6, 6, 0, "Text");
			}break;

		case 19:		//Cows
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 350.21, -102.78, 6, 6, 0, "Cows");
			}break;

		case 20:		//Patty
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 350.21, -102.78, 6, 6, 0, "Cow God");
			}break;

		case 21:		//Frogs
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 359.48, -284.97, 6, 6, 0, "Frogs");
			}break;

		case 22:		//Eanna
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 359.48, -284.97, 6, 6, 0, "Frog God");
			}break;

		case 23:		//Murloc Man
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 359.48, -284.97, 6, 6, 0, "Murloc Man");
			}break;

		case 24:		//Snakes
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 282.57, 50.04, 6, 6, 0, "Snakes");
			}break;

		case 25:		//Hissyfit
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 282.57, 50.04, 6, 6, 0, "Snake God");
			}break;

		case 26:		//Spiders
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 282.57, 50.04, 6, 6, 0, "Spiders");
			}break;

		case 27:		//Spider Queen
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 282.57, 50.04, 6, 6, 0, "Spider Queen");
			}break;

		case 28:		//Yeti
		{
			SendQuickMenu(1);
			Plr->Gossip_SendPOI( 282.57, 50.04, 6, 6, 0, "Yeti Man");
			}break;
...
void SetupGuardGossip(ScriptMgr * mgr)
{
	...
	GossipScript * rockstar = (GossipScript*) new RNGuard();
	...
	mgr->register_gossip_script(770007,rockstar);		// RN Guard
}	
