...
/*
 =======================================================================================================================
	How to add a new paladin spell to the dummy spell handler: 1) Add a new function to handle the spell at the end of
	this file but before the SetupPaladinSpells() function. SetupPaladinSpells() must always be the last function. 2)
	Register the dummy spell by adding a new line to the end of the list in the SetupPaladinSpells() function. Please
	look at how the other spells are handled and try to use the same variable names and formatting style in your new
	spell handler.
 =======================================================================================================================
 */
bool SealOfRighteousness(uint32 i, Aura *pAura, bool apply)
{
	...
	{
	case 20154: /* Rank 1: "Melee attacks cause an additional
				 * $/87;
				 * 20187s3 to
				 * $/25;
				 * 20187s3 Holy damage." */
	...
	if(apply == true)
	{
		...
		/*
			 ...
			 if(GetProto()->SpellGroupType) { SM_FIValue(u_caster->SM_FDummy,&value,GetProto()->SpellGroupType);
		...
		/*~~~~~~~~~~~~~~~~~~~~~~~~~*/
		(( Player * ) u_caster)->AddOnStrikeSpellDamage(pAura->GetSpellProto()->Id, min_dmg, max_dmg);
