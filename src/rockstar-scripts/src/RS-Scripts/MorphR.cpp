	...
	void GossipSelectOption(Object *pObject, Player *Plr, uint32 Id, uint32 IntId, const char *Code)
	{
		...
		case 1:
			{					/* Base Menu */
				...
				Menu->AddItem(GOSSIP_ICON_INNKEEPER, "[*] Parrot", 13);
		...
		case 2:
			{					/* Boss Menu */
				objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 2593, Plr);
				Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "[+] Boss Menu [+]", 1);
		...
		case 3:
			{					/* Base Menu */
				objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 2593, Plr);
				Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "[+] Mob Menu [+]", 1);
		...
		case 4:
			{
				objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 2593, Plr);
				Menu->AddItem(GOSSIP_ICON_TXTBALLOON, "[+] FriendlyNPC Menu [+]", 99);
...
void SetupItem_Morpher(ScriptMgr *mgr)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
