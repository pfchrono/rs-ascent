/*
	 ...
	 <http://www.ascentemu.com/> Copyright (C) 2007-2008 Moon++ Team
	 <http://www.moonplusplus.info/> This program is free software: you can
...
{
public:
	OrbOfCommand(GameObject *goinstance) :
...
class OrbOfTransLocUC :
	public GameObjectAIScript
{
public:
	OrbOfTransLocUC(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	void OnActivate(Player *pPlayer)
	{
		if
		(
			pPlayer->getRace() == RACE_TAUREN
		||	pPlayer->getRace() == RACE_TROLL
		||	pPlayer->getRace() == RACE_ORC
		||	pPlayer->getRace() == RACE_UNDEAD
		||	pPlayer->getRace() == RACE_BLOODELF
		)
		{
			pPlayer->SafeTeleport(530, 0, 10021.254883f, -7014.893066f, 49.717690f, 4.00532f);	/* teleports to
																								 * Silvermoon */
		}
		else
		{
...
class OrbOfTransLocSILVM :
	public GameObjectAIScript
{
public:
	OrbOfTransLocSILVM(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new OrbOfTransLocSILVM(GO);
	}
...
class FalconTowerUpper :
	public GameObjectAIScript
{
public:
	FalconTowerUpper(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new FalconTowerUpper(GO);
	}
...
class FalconTowerLower :
	public GameObjectAIScript
{
public:
	FalconTowerLower(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new FalconTowerLower(GO);
	}
...
class FirewingPointOrb1 :
	public GameObjectAIScript
{
public:
	FirewingPointOrb1(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new FirewingPointOrb1(GO);
	}
...
class FirewingPointOrb2 :
	public GameObjectAIScript
{
public:
	FirewingPointOrb2(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new FirewingPointOrb2(GO);
	}
...
class duskwitherspirebottom :
	public GameObjectAIScript
{
public:
	duskwitherspirebottom(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new duskwitherspirebottom(GO);
	}
...
class duskwitherspiretop :
	public GameObjectAIScript
{
public:
	duskwitherspiretop(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new duskwitherspiretop(GO);
	}
...
class Blacksmithing_Plans_Use :
	public GameObjectAIScript
{
public:
	Blacksmithing_Plans_Use(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new Blacksmithing_Plans_Use(GO);
	}
	...
	void OnLootTaken(Player *pLooter, ItemPrototype *pItemInfo)
	{
		...
		pLooter->GetMapMgr()->GetInterface()->SpawnCreature(11120, SSX, SSY, SSZ, SSO, true, false, 0, 0)->Despawn
			(
				600000,
				0
			);
...
{
public:
	GongOfBethekk(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
class TerokksDownfall :
	public GameObjectAIScript
{
public:
	TerokksDownfall(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	void OnActivate(Player *pPlayer)
	{
		if(pPlayer->GetQuestLogForEntry(11073) && pPlayer->GetItemInterface()->GetItemCount(32720, 1))
		{
			...
			pPlayer->GetMapMgr()->GetInterface()->SpawnCreature(21838, SSX, SSY, SSZ, SSO, true, false, 0, 0)->Despawn
				(
					600000,
					0
				);
...
class VilebranchKidnapper :
	public GameObjectAIScript
{
public:
	VilebranchKidnapper(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new VilebranchKidnapper(GO);
	}
	...
	void OnActivate(Player *pPlayer)
	{
		...
		pPlayer->GetMapMgr()->GetInterface()->SpawnCreature(14748, SSX + 1, SSY, SSZ, SSO, true, false, 0, 0)->Despawn
			(
				600000,
				0
			);
		pPlayer->GetMapMgr()->GetInterface()->SpawnCreature(14748, SSX, SSY, SSZ, SSO, true, false, 0, 0)->Despawn
			(
				600000,
				0
			);
...
class GongOfZulFarrak :
	public GameObjectAIScript
{
public:
	GongOfZulFarrak(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
{
public:
	Obsidias_Egg(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
class Rivendarks_Egg :
	public GameObjectAIScript
{
public:
	Rivendarks_Egg(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
{
public:
	Furywings_Egg(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
{
public:
	Insidions_Egg(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
...
class Corrupt_Minor_Manifestation_Water_Object :
	public GameObjectAIScript
{
public:
	Corrupt_Minor_Manifestation_Water_Object(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new Corrupt_Minor_Manifestation_Water_Object(GO);
	}
...
class Telathion_the_Impure_Object :
	public GameObjectAIScript
{
public:
	Telathion_the_Impure_Object(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	static GameObjectAIScript *Create(GameObject *GO)
	{
		return new Telathion_the_Impure_Object(GO);
	}
...
class UlagTheCleaver :
	public GameObjectAIScript
{
public:
	UlagTheCleaver(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	void OnActivate(Player *pPlayer)
	{
		...
		Ulag = pPlayer->GetMapMgr()->GetInterface()->GetCreatureNearestCoords
			(
				2390.101807f,
				336.676788f,
				40.015614f,
		...
		pDoor = pPlayer->GetMapMgr()->GetInterface()->GetGameObjectNearestCoords
			(
				2388.480029f,
				338.3901f,
				40.092899f,
		...
		pCreature = pPlayer->GetMapMgr()->GetInterface()->GetCreatureNearestCoords
			(
				2390.101807f,
				336.676788f,
				40.015614f,
...
class DustySpellbooks :
	public GameObjectAIScript
{
public:
	DustySpellbooks(GameObject *goinstance) :
	GameObjectAIScript(goinstance)
	{
	}
	...
	void OnLootTaken(Player *pLooter, ItemPrototype *pItemInfo)
	{
		...
		pLooter->GetMapMgr()->GetInterface()->SpawnCreature
			(
				1770,
				SSX,
				SSY,
			...
			(
				...
				LANG_UNIVERSAL,
				"The Sons of Arugal will rise against all who challenge the power of the Moonrage!"
			);
	}
};
